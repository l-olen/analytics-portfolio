...
SPEND_FACTOR  = 12
VOLUME_FACTOR = 4
UZS_TO_USD    = 1 / 13_000   # approx exchange rate for avg_price column
PRICE_SCALE   = 3             # inflate demo appointment price ×3 on top of USD
...
# "S"       → ×SPEND_FACTOR
# "V"       → ×VOLUME_FACTOR
# "P"       → convert UZS→USD, then ×PRICE_SCALE
...
RULES = {
    ...
    "medical_monthly_trend.csv": {
        "contacts": "V", "qualified": "V", "qual_pct": None,
        "call_n": "V", "paid_n": "V", "organic_n": "V", "other_n": "V",
    },
    "medical_ga4_channels.csv": {
        "sessions": "V", "conversions": "V", "cr_pct": None, "engaged_sessions": "V",
    },
    "medical_ga4_monthly.csv": {
        "sessions": "V", "conversions": "V",
    },
    "medical_ga4_events.csv": {
        "total": "V", "paid": "V", "paid_share_pct": None,
    },
    "medical_appointments.csv": {
        "appt_leads": "V", "won": "V", "avg_price_raw": "P",
    },
}

# rename column avg_price_raw → avg_price_usd
COLUMN_RENAME = {
    "avg_price_raw": "avg_price_usd",
}
    ...
    for row in rows_in:
        ...
        for col in headers:
            ...
            if rule == "NAME":
                ...
                # UZS → USD → ×PRICE_SCALE
                scaled[ocol] = apply_factor(val, UZS_TO_USD * PRICE_SCALE)
